...
G_EPOCHS = 300
LEARNING_RATE = 7e-5
LAMBDA = torch.tensor(0.1).to(device)
...
LD,conv_layer,total_layer,out_channels,k_size = network_architecture_search()
...
test_dataloader = DataLoader(test_dataset,batch_size=20 * BATCHSIZE,shuffle=True)
val_dataloader = DataLoader(val_dataset,batch_size=20 * BATCHSIZE,shuffle=True)
